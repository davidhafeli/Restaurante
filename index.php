...
$sentencia=$conexion->prepare("SELECT * FROM `banners` ORDER BY id DESC limit 1");
$sentencia->execute();
$lista_banners= $sentencia->fetchAll(PDO::FETCH_ASSOC);

$sentencia=$conexion->prepare("SELECT * FROM `tbl_colaboradores` ORDER BY id DESC"); // alterar registro quitando limit 1
$sentencia->execute();
$lista_colaboradores= $sentencia->fetchAll(PDO::FETCH_ASSOC);

$sentencia=$conexion->prepare("SELECT * FROM `tbl_testimonios` ORDER BY id DESC limit 2"); // alterar registro quitando limit 1
$sentencia->execute();
$lista_testimonios= $sentencia->fetchAll(PDO::FETCH_ASSOC);

$sentencia=$conexion->prepare("SELECT * FROM `tbl_menu` ORDER BY id DESC limit 4"); // alterar registro quitando limit 1
$sentencia->execute();
...
<section class="container-fluid p-0">
    <div class="banner-img"style="position:relative; background:url('images/slider-image1.jpg') center/cover no-repeat; height:400px;">
        ...
        <div class="banner-text" style="position: absolute; top:50%; left:50%; left:50%; transform: translate(-50%, -50%); text-align:center; color:#fff;">
    ...
    <section id="chefs" class="container mt-4 text-center" >
        ...
        <div class="col-md-4">
            <div class="card">
                <img src="images/colaboradores/<?php echo $colaborador['foto']; ?>" alt="Chef 1" 
                class="card-img-top" >
                <div class="card-body">
    ...
    <div class="row row-cols-1 row-cols-md-4 g-4">
        ...
        <?php foreach($lista_menu as $registro) { ?>
         <div class="col d-flex">
            <div class="card">
            <img src="./images/menu/<?php echo $registro["foto"];?>" alt="" class="card-img-top">
                <div class="card-body">
                <h5 class="card-title"> <?php echo $registro["nombre"];?></h5>
                <p class="card-text- small"><strong><?php echo $registro["ingredientes"];?></strong>
                <p class="card-text"><strong><?php echo $registro["precio"];?></strong>
                </div>
            </div>
        </div>
    ...
    <!-- form control cambia el formato -->
    ...
    <div class="mb-3">
        ...
        <!-- btn btn-primary cambia el formato -->
    </form>
    ...
    <div id="horario" class="text-center bg-light p-4">
        ...
        <p><strong>11:00 a.m. - 10:00 pm</strong></p>
        </div>
        ...
        <p><strong>07:00 a.m. - 2:00 pm</strong></p>
        </div>
